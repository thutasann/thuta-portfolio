...
export const RichTextComponents = {
  ...
  block: {
    ...
    h2: ({ children }: any) => <h2 className='text-dark dark:text-light text-4xl font-bold py-5'>{children}</h2>,
    h3: ({ children }: any) => <h3 className='text-dark dark:text-light text-3xl font-bold py-5'>{children}</h3>,
    h4: ({ children }: any) => <h4 className='text-dark dark:text-light text-2xl font-bold py-7'>{children}</h4>,
    p: ({ children }: any) => <p className='text-dark dark:text-light text-2xl text-justify mt-3'>{children}</p>,
