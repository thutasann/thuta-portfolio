...
export const TwitterIcon = ({ className, ...rest }: IIcons) => (
...
export const LinkedInIcon = ({ className, ...rest }: IIcons) => (
...
export const PinterestIcon = ({ className, ...rest }: IIcons) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 256 256' {...rest} className={`w-full h-auto ${className}`}>
    <path fill='none' d='M0 0h256v256H0z' />
    <path
      fill='#CB1F27'
...
export const DribbbleIcon = ({ className, ...rest }: IIcons) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 256 256' {...rest} className={`w-full h-auto ${className}`}>
    <path fill='none' d='M0 0h256v256H0z' />
...
export const CircularText = ({ className, ...rest }: IIcons) => (
  <svg
...
export const LinkArrow = ({ className, ...rest }: IIcons) => (
